...
int main()
{
    ...
    h.onMessage([&lane, &rv, &map_waypoints_x, &map_waypoints_y, &map_waypoints_s, &map_waypoints_dx, &map_waypoints_dy](uWS::WebSocket<uWS::SERVER> ws, char* data, size_t length,
        uWS::OpCode opCode) {
        ...
        if (length && length > 2 && data[0] == '4' && data[1] == '2') {
             ...
             */
                    ...
                    for (int i = 0; i < sensor_fusion.size(); ++i) {
                        ...
                        if ((curr_lane != lane) && (check_car_s < car_s) && ((check_car_s - car_s) > -30)) {
                            if (curr_lane < lane) {
                                left_car = true;
                            }
                            else if (curr_lane > lane) {
                    ...
                    else if (rv < 44) { // Upper bound is 50 mph - accelerate.
                        rv += 0.3;
                    }
